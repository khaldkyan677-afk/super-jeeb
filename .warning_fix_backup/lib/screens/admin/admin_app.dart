    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.campaign), label: 'بث'),
  ...
  Widget _statCard(String title, String val, IconData icon, Color color) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF2B2D42).withValues(alpha: 0.4),
...
class _AdminRequestsTabState extends State<AdminRequestsTab> {
  ...
  Widget build(BuildContext context) {
    final filtered = _filter == 0
        ...
        : _requests
              .where(
                (r) => r['type'] == (_filter == 1 ? 'merchant' : 'courier'),
              )
              .toList();
    ...
    return Column(
      children: [
        Container(
          padding: const EdgeInsets.all(15),
          color: const Color(0xFF660F24).withValues(alpha: 0.3),
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color: isPending ? Colors.amber : const Color(0xFF25D366),
                    fontSize: 9,
                    fontWeight: FontWeight.bold,
                  ),
                ),
            ...
            children: _banks.map((b) {
              ...
              return InkWell(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    color: sel
                        ? (b['c'] as Color).withValues(alpha: 0.15)
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      color: active ? const Color(0xFF25D366) : Colors.amber,
                      fontSize: 9,
                      fontWeight: FontWeight.bold,
                    ),
                  ),
          ...
          PopupMenuButton<String>(
            ...
            onSelected: (v) {
              if (v == 'delete') {
                ...
                setState(() => c['status'] = active ? 'pending' : 'active');
              }
            },
            itemBuilder: (_) => [
              const PopupMenuItem(
              ...
              const PopupMenuItem(
                value: 'delete',
                child: Text('حذف', style: TextStyle(color: Color(0xFFEF233C))),
              ),
            ],
          ),
        ],
...
class _AdminSosState extends State<AdminSos> {
  ...
  Widget _card(Map<String, dynamic> r, int i) {
    return Container(
      ...
      padding: const EdgeInsets.all(15),
      decoration: BoxDecoration(
        color: const Color(0xFFEF233C).withValues(alpha: 0.06),
        borderRadius: BorderRadius.circular(15),
        border: Border.all(
          color: const Color(0xFFEF233C).withValues(alpha: 0.3),
        ),
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Column(
                children: [
                  const Icon(Icons.storage, color: Color(0xFFEF233C), size: 60),
                  const SizedBox(height: 15),
                  const Text(
                    'إجمالي المساحة',
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                Expanded(child: _box('مجانية', '89 متجر', Colors.grey)),
                const SizedBox(width: 10),
                Expanded(
                  child: _box('فضية', '32 متجر', const Color(0xFF95A5A6)),
                ),
              ],
            ),
            const SizedBox(height: 10),
            Row(
              children: [
                Expanded(
                  child: _box('ذهبية', '21 متجر', const Color(0xFFD4AF37)),
                ),
                const SizedBox(width: 10),
                Expanded(
                  child: _box('Plus', '156 عميل', const Color(0xFFEF233C)),
                ),
              ],
            ),
            const SizedBox(height: 25),
            ...
            Container(
              ...
              child: const Column(
                children: [
                  Icon(Icons.trending_up, color: Color(0xFF25D366), size: 45),
                  SizedBox(height: 12),
                  Text(
                    '475,000 YER',
                    style: TextStyle(
  ...
  Widget _card(
    ...
    return Container(
      ...
      child: ListTile(
        ...
        trailing: const Icon(Icons.visibility, color: Colors.white54, size: 20),
      ),
    );
  }
              ...
              child: Container(
                ...
                child: const Center(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(Icons.phone_iphone, color: Colors.white24, size: 80),
                      SizedBox(height: 15),
                      Text(
                        'عرض واجهة داخل التطبيق',
          ...
          Padding(
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    const Icon(Icons.timer, color: Color(0xFFEF233C), size: 16),
                    ...
                    Container(
                      ...
                      child: Text(
                        active ? 'نشط' : 'موقوف',
                        style: TextStyle(
                          color: active ? const Color(0xFF25D366) : Colors.grey,
                          fontSize: 10,
                          fontWeight: FontWeight.bold,
                        ),
                      ),
