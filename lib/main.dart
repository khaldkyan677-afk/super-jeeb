    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: ThemeData.dark().textTheme.apply(
          bodyColor: Color(0xFFFDF5E6),
          displayColor: Color(0xFFFDF5E6),
        ),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFFFFF233).withValues(alpha: 0.15),
                  shape: BoxShape.circle,
                ),
                child: const Icon(
                  Icons.phone_iphone,
