              ...
              child: FadeTransition(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('سوبر جيب | بوابة التجار',
                        style: TextStyle(
                            fontSize: 24,
                            fontWeight: FontWeight.bold,
                            color: Colors.white)),
                    const SizedBox(height: 8),
                    const Text('شركاء النجاح.. مبيعاتك أسرع!',
                        style: TextStyle(
                            fontSize: 15,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const Text('Super Jeeb Merchant',
                style: TextStyle(
                    fontSize: 22,
                    fontWeight: FontWeight.bold,
                    color: Colors.white)),
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                prefixIcon:
                    Icon(Icons.phone_iphone, color: Color(0xFFEF233C)),
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                prefixIcon:
                    Icon(Icons.lock_outline, color: Color(0xFFEF233C)),
            ...
            ElevatedButton(
              ...
              child: const Text('تسجيل الدخول وبث الرادار',
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 16,
                      fontWeight: FontWeight.bold)),
            ...
            TextButton(
              onPressed: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (_) => const MerchantRegister())),
              child: const Text('👋 انضم كشريك وسجّل متجرك',
                  style: TextStyle(
                      color: Color(0xFFEF233C),
                      fontWeight: FontWeight.bold)),
            ),
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                        content: Text('✔️ تم إرسال طلبك للمراجعة')));
          ...
          children: [
            ...
            GridView.count(
              ...
              children: [
                InkWell(
                  onTap: () {
                    if (!_open) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content: Text('⚠️ افتح المتجر أولاً')),
                      );
                      return;
                    }
                    Navigator.push(
                ...
                _sCard(Icons.stacked_line_chart, '+24%',
                    'نمو المبيعات', const Color(0xFF25D366)),
                InkWell(
                  onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const MerchantProducts())),
                  child: _sCard(Icons.inventory, 'المستودع',
                      'إدارة المنتجات', Colors.orange),
                ),
                InkWell(
                  onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const MerchantWallet())),
                  child: _sCard(Icons.account_balance_wallet, 'المحفظة',
                      'تصفية الحسابات', Colors.amber),
                ),
                InkWell(
                  onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const MerchantAds())),
                  child: _sCard(Icons.campaign, 'إعلاناتي',
                      'قدّم على إعلان', const Color(0xFFEF233C)),
                ),
                InkWell(
                  onTap: () => Navigator.push(
                      context,
                  ...
                  child: _sCard(Icons.workspace_premium, 'اشتراكي',
                      'طور متجرك', Colors.purple),
                ),
              ],
            ),
          ],
    ...
    return Column(
      children: [
        CircleAvatar(
          radius: 18,
          backgroundColor:
              passed ? const Color(0xFFEF233C) : const Color(0xFF1B1C2A),
          child: Icon(icon,
              color: passed ? Colors.white : Colors.white24, size: 16),
        ),
        const SizedBox(height: 4),
        Text(label,
            style: TextStyle(
                color: passed ? Colors.white : Colors.white24, fontSize: 9)),
      ],
    );
  }
  ...
  Widget _reason(String t) {
    return ListTile(
      ...
      onTap: () {
        Navigator.pop(context);
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('تم رفض الطلب: $t')),
        );
      },
    );
  }
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                        content: Text(
                            '✅ تم إرسال طلب الإعلان للإدارة للمراجعة'),
...
class MerchantSubscriptions extends StatelessWidget {
  ...
  static const plans = [
    ...
    },
    {
      ...
      'features': ['عمولة 8%', 'إعلانان مجانًا', 'دعم VIP', 'ترتيب أول',
        'شهادة موثقة'],
    },
  ];
