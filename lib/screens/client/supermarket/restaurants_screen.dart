...
class _RestaurantsScreenState extends State<RestaurantsScreen> {
  ...
  final List<String> _cats = ['الكل', 'قريب منك', 'مطعم شعبي/مندي', 'مطعم أسماك', 'وجبات سريعة/برجر', 'بيتزا ومعجنات', 'كافيه/حلويات', 'محل عصائر'];
  ...
  Future<void> _load() async {
    ...
    final s = await SupermarketService().getStoresByCategory('مطاعم');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: const Color(0xFF0D0D12), elevation: 0,
        ...
        title: Text('مطاعم', style: GoogleFonts.cairo(color: Colors.white, fontWeight: FontWeight.w600)),
        centerTitle: true),
      body: Column(children: [
        Padding(padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
          child: SmSearchBar(hint: 'ابحث عن مطعم...', onChanged: (v) => setState(() => _query = v))),
        Padding(padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
